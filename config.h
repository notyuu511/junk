...
static Key keys[] = {
	...
	{ 0     ,                       XF86XK_AudioLowerVolume,  spawn,          {.v = vminus } },
	{ 0     ,                       XF86XK_AudioRaiseVolume,  spawn,          {.v = vplus } },
	{ 0     ,                       XF86XK_MonBrightnessDown, spawn,          {.v = lightminus } },
	{ 0     ,                       XF86XK_MonBrightnessUp,   spawn,          {.v = lightplus } },
	{ MODKEY,                       XK_grave,                 spawn,          {.v = animepape } },
	{ MODKEY|ShiftMask,             XK_h,                     spawn,          {.v = hpape } },
	{ MODKEY|ShiftMask,             XK_b,                     spawn,          {.v = bardpape } },
	{ MODKEY|ShiftMask,             XK_grave,                 spawn,          {.v = emergencypape } },
